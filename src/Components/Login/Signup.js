            ...
            <div className="my-5 card w-50 p-4 mx-auto">
                ...
                <div className="mx-auto">
                    <form>
                        ...
                        <input className='form-control my-2 mx-auto' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} name='password' type="password" placeholder="Confirm-Password" required/>
                        <button onClick={register} type='submit' className='btn btn-success form-control'>Sign Up</button>
                    </form>
                    <p className='mt-3 text-center'>Have a Account? <Link to='/login'><span className='register'> Login Now</span></Link></p>
                </div>
            </div>
        </div>
    );
